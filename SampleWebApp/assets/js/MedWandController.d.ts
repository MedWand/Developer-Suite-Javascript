import type { BrowserSerialPort, SerialPortRequestOptions } from "./browserTypes";
import { TypedEventTarget } from "./events";
import { LicenseState } from "./core/enumLicense";
import { DeviceState } from "./core/enumDeviceState";
import { MedWandDeviceError } from "./core/medWandDeviceError";
import { ReadingState } from "./core/enumReadingState";
import { MedWandReading } from "./core/medWandReading";
import { MedWandGeneration } from "./core/enumGeneration";
import { MedWandSensor } from "./core/enumSensor";
import { MicrophoneModes } from "./core/enumMicrophoneMode";
import { CameraModes, FocusModes } from "./core/enumCameraMode";
import { OtoscopeMaskInfo } from "./core/otoscopeMaskInfo";
...
export declare class MedWandController extends TypedEventTarget<MedWandControllerEvents> {
     ...
     */
    getGeneration(): Promise<MedWandGeneration>;
    /**
     ...
     */
    cameraResizeMask(increment: number): void;
    /**
     * Gets the current otoscope mask geometry.
     */
    get cameraOtoscopeMaskInfo(): OtoscopeMaskInfo | null;
    /**
     * Sets the camera LED intensity.
     */
    setCameraLedIntensity(value: number): Promise<void>;
    /**
     * Sets the camera LED intensity.
     */
    SetCameraLedIntensity(value: number): Promise<void>;
     ...
     */
    setCameraFocusMode(focusMode: FocusModes, resetLastValue?: boolean): Promise<boolean>;
    /**
     * Sets the camera focus mode when the active browser camera supports it.
     */
    SetCameraFocusMode(focusMode: FocusModes, resetLastValue?: boolean): Promise<boolean>;
     ...
     */
    setCameraManualFocus(value: number): Promise<boolean>;
    /**
     * Sets the manual focus distance when the active browser camera supports it.
     */
    SetCameraManualFocus(value: number): Promise<boolean>;
     ...
     */
    Dispose(): void;
    protected setLedIntensity(value: number): Promise<void>;
    protected startStethoscope(): Promise<boolean>;
    protected stopStethoscope(): Promise<boolean>;
    protected startCamera(): Promise<boolean>;
    protected stopCamera(): Promise<boolean>;
    private startSensor;
